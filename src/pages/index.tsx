...
const partners = [
    ...
    positions = [
        ...
        // },
        {
            name: "EqualizerRP",
            description:
                "Equalizer roleplay is a FiveM roleplay server with a focus on community building and roleplay.",
            rank: "CEO - Management",
    ...
    projects = [
        ...
        },
        {
            ...
            description:
                "Join 1,585,911 Users, Use MythBot Radio, With over 30+ Radio Stations From All Over The World.",
        ...
        },
        {
            ...
            description:
                "I love to randomly update or recreate my portfolio with new projects and technologies, here is my old portfolio.",
            image: "https://cdn.mythbot.org/img/dev_aynfh83n.gif",
        ...
        return (
            ...
            >
                ...
                <p className="text-gray-800 dark:text-gray-300 leading-6 font-light tracking-wide mb-6">
                    I am Tom (jokerxtd) . 31 y/o Inspired Developer/Software Engineer , Verified Discord Bot Developer ,
                    and Web Developer
                </p>
                ...
                <p className="text-gray-800 dark:text-gray-300 leading-6 font-light tracking-wide mb-6">
                    ...
                    , so I can learn from others and showcase what I know. In total, all of my open sourced projects
                    have earned me <span className="font-bold text-black dark:text-slate-200">{stats.stars}</span> stars
                    on GitHub, and <span className="font-bold text-black dark:text-slate-200">{stats.forks}</span>{" "}
                ...
                <section
                    id="get-in-touch"
                    data-aos="fade-up"
                    className="rounded-lg bg-white/10 dark:bg-black/10 border border-slate-400 hover:border-slate-700 dark:border-slate-800 dark:hover:border-slate-600 transition-colors duration-75 cursor-pointer"
                >
                    <span>Want to Hire me or just a General Inquiry, Please get in touch!</span>
                    <a
                        href="/contact"
                        rel="noreferrer"
                        className="border border-slate-400 hover:border-slate-700 dark:border-slate-800 dark:hover:border-slate-600"
                    >
                        Contact Me
                    </a>
                </section>
...
export async function getStaticProps() {
    const stats = await fetch("https://api.github-star-counter.workers.dev/user/jokerxtd").then(res => res.json()),
        repos = await fetch("https://api.github.com/users/jokerxtd/repos?type=owner&per_page=100").then(res =>
            res.json()
        ),
        topRepos = repos
